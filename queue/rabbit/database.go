...
type Database struct {
	once    resync.Once
	db      *amqp.Connection
	exchgs  map[string]Exchange
	handler []queue.ContextHandler
}
...
func (o *Database) Init(dsn string, opts ...Option) (err error) {
	...
	o.exchgs = make(map[string]Exchange)
	o.handler = make([]queue.ContextHandler, 0)
...
// 		handler    = false
// ****************************************************************************************************************************************
func (o *Database) ExchangeDeclare(name string, opts ...Option) (e Exchange, err error) {
	defer o.once.Reset()
